    ...
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-500">
      <div
        className={`w-full transition-all duration-500 ${
          scrolled
            ? 'bg-[#000000]/50 backdrop-blur-2xl border-b border-white/[0.08] py-3.5 shadow-[0_10px_30px_rgba(0,0,0,0.8)]'
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-6">
            ...
            {/* Center: Spaced Monospaced Navigation */}
            <nav className="hidden md:flex items-center gap-6 lg:gap-8 font-mono text-[11px] tracking-[0.22em] uppercase text-zinc-400">
              <button
            ...
            {/* Right: Rounded Outline Action Button */}
            <div className="flex items-center gap-3 shrink-0">
              <button
                ...
                onMouseEnter={() => sound.playHover()}
                className="px-5 sm:px-6 py-2 rounded-xl border border-[#E32124] text-[#E32124] hover:bg-[#E32124] hover:text-white font-mono text-xs tracking-[0.2em] uppercase transition-all duration-300 shadow-[0_0_20px_rgba(227,33,36,0.25)] hover:shadow-[0_0_30px_rgba(227,33,36,0.6)] active:scale-95"
              >
                ЗАБРОНИРОВАТЬ
              </button>
            </div>
