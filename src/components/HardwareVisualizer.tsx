    ...
    <section id="hardware" className="relative py-24 sm:py-32 bg-[#06060A] border-t border-b border-white/[0.08] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          {/* Quick status pill */}
          <div className="glass-panel px-4 py-2.5 rounded-2xl border border-white/[0.08] flex items-center gap-3">
            <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-pulse" />
            <div className="text-xs font-mono">
              <span className="text-white font-bold">Бездисковая сеть &gt;1 Гбит/с</span>
              <span className="text-zinc-400 block text-[10px]">Пинг 0.8ms • Мгновенный запуск игр</span>
            </div>
          </div>
        </div>
